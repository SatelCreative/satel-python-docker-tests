...
[ -d "mnt/samba/${APP_NAME}" ] || mkdir "mnt/samba/${APP_NAME}"
docker cp "$(docker-compose ps -q webapp)":"/python/app/${APP_NAME}_${CLEAN_BRANCH_NAME}_openapi.json mnt/samba/${APP_NAME}_${CLEAN_BRANCH_NAME}_openapi.json"
